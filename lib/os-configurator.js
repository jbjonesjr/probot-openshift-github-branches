...
module.exports = {
   ...
   try {
     ...
     var full_config = substitute(raw_config, {tokens: Object.assign({}, props, {'token':process.env.OS_SA_TOKEN, 'server': process.env.OS_SA_SERVER})});

     //console.log('full',require('util').inspect(full_config, false, null));
